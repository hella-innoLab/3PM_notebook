...
#rcopts=" -V- -n ${nprocs} -w- -I+ -ab 1 -ad 65536 -lw 1.0e-6 -dc 1 -dt 0 -dj 0 -faa "
rcopts=" -V- -n ${nprocs} -w- -I+ -ab 1 -ad 8192 -lw 1.0e-6 -dc 1 -dt 0 -dj 0 -faa " # low to show...
...
for var in blinds_20deg_BSDF blinds_20deg_geom ; do
  ...
  printf " calculate direct sun matrix for system ${var}... \n"
  time rcontrib < pts/tutorial_workplane.pts \
       ${rcopts} -e MF:${mf_sun_pos} -f reinhart.cal -b rbin -bn Nrbins -m solar \
       ${octree} > matrices/tutorial_room_5pm_sensors_${var}.dsmx
